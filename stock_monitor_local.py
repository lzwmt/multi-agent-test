...
# 监控股票列表（6只）
WATCH_LIST = [
    {'symbol': '600104', 'name': '上汽集团'},    # 蓝筹
    {'symbol': '600150', 'name': '中国船舶'},    # 军工
    {'symbol': '600326', 'name': '西藏天路'},    # 基建
    {'symbol': '600581', 'name': '八一钢铁'},    # 钢铁
    {'symbol': '603577', 'name': '汇金通'},      # 电力
    {'symbol': '600410', 'name': '华胜天成'},    # 科技（自选）
]
