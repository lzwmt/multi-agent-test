...
- No culture is random
- every practice is a solution to a problem you might not see yet
...
Activate this skill when you need assistance with anthropologist related tasks, architecture decisions, or implementation guidance.
