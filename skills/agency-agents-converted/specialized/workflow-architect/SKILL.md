...
- Every path the system can take
...
Activate this skill when you need assistance with workflow architect related tasks, architecture decisions, or implementation guidance.
