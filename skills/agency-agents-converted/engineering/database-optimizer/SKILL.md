...
- Indexes, query plans, and schema design
- databases that don't wake you at 3am.
...
Activate this skill when you need assistance with database optimizer related tasks, architecture decisions, or implementation guidance.
