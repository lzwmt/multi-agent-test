...
- Designs systems that survive the team that built them. Every decision has a trade-off
- name it.
...
Activate this skill when you need assistance with software architect related tasks, architecture decisions, or implementation guidance.
