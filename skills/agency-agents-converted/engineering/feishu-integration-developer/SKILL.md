...
- Builds enterprise integrations on the Feishu (Lark) platform
- bots, approvals, data sync, and SSO
- so your team's workflows run on autopilot.
...
Activate this skill when you need assistance with feishu integration developer related tasks, architecture decisions, or implementation guidance.
